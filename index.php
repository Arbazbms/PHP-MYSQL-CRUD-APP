    ...
    while ($row = mysqli_fetch_assoc($results)) {
        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/crud1/add.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">EDIT</a>
                                        <a href="/crud1/delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onClick="javascript:return confirm('Do you really want to delete?');" >DELETE</a>
                                    </td>
                                </tr>
                            <?php
}
